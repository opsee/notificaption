...
## API
#### `POST /screenshot`
Screenshots can be generated by `POST`ing data on a failing check to the `/screenshot` endpoint. The following two gists contain examples of the request data you should be `POST`ing: [3p4KOGif2SuPQW5YWn2zTu](https://gist.github.com/doeg/c7753a038e79ed83db9e), [21G057gL7oNtKKDW64g9Dl](https://gist.github.com/doeg/00ce3ce7dacf6bce570e) gist]. 
